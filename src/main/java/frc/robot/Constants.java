...
public final class Constants
{
    ...
    public static final double              DEFAULT_HANGER_MIN_POSITION     = -3755;
    public static final double              DEFAULT_HANGER_MAX_POSITION     = -1780;

    public static final int                 DEFAULT_BALLPATH_MAX_BALL_COUNT = 5;
    public static final double              DEFAULT_BALLPATH_JAM_TIME       = 1.2;
    public static final double              DEFAULT_BALLPATH_RAMP_MIN       = 0.02;
    public static final double              DEFAULT_BALLPATH_RAMP_STEP      = 0.05;
    public static final double              DEFAULT_BALLPATH_SPEED          = 0.55;

    public static final double              DEFAULT_PICKUP_SPEED            = 1;
    public static final double              DEFAULT_PICKUP_CLOG_TIME        = 2;
    public static final double              DEFAULT_PICKUP_STOW_DELAY       = 1;

    public static final int                 DEFAULT_SHOOTER_RPM_DEADBAND    = 50;
    public static final double              DEFAULT_SHOOTER_NEAR_DISTANCE   = 10;
    public static final double              DEFAULT_SHOOTER_FAR_DISTANCE    = 300;
    public static final double              DEFAULT_HOOD_MIN_POSITION       = 1220;
    public static final double              DEFAULT_HOOD_NEAR_TARGET        = DEFAULT_HOOD_MIN_POSITION - 291;
    public static final double              DEFAULT_HOOD_FAR_TARGET         = DEFAULT_HOOD_MIN_POSITION - 504;
